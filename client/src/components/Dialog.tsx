...
const DialogChildrenContainer = styled.div(({ maxWidth }: { maxWidth?: boolean }) => [
...
export const Dialog = (
  { focusFirst, focusAfterClosed, onClose, autoFocus, children, maxWidth, ...rest }: DialogProps
) => {
...
export const DialogTitle = ({ onClose, children, styles, ...rest }: DialogTitleProps) => {
  return (
...
export const DialogContent = ({ children, ...rest }: HTMLAttributes<HTMLDivElement>) => {
  return (
...
export const DialogActions = ({ children, ...rest }: HTMLAttributes<HTMLDivElement>) => {
  return (
